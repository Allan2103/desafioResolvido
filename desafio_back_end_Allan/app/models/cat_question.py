...
lista_gatos = [
    ...
    # valor int da idade estava em str
    Gato(5, "Salem", "Bombay", 6),
    Gato(6, "Luna", "Ragdoll", 1),
    Gato(7, "Simba", "Bengal", 2),
    # valor int do id estava em str, valor alterado de 5 para 8
...
datas_nascimento = [
    ...
    # Esse valor é de uma tupla ao invés de dicionario
    ...
    # O id 31 não existe e possui os mesmo erros
    # ('id: 31', 'data_nascimento: datetime(2018, 2, 9'),
